...
minetest.register_node("tech:energium_wire", {
  description = "Energium Wire",
  tiles = {"tech_energium_wire.png",},
...
minetest.register_craft({
  output = "tech:energium_wire 12",
  recipe = {
  {"tech:energium_ingot", "tech:energium_ingot", "tech:energium_ingot",},
  {"", "", ""},
  {"", "", ""},
  }
})
