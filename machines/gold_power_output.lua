...
minetest.register_node("tech:gold_power_output", {
  description = "Gold Power Output",
  tiles = {"tech_gold_power_output.png",},
...
tech.register_generator("tech:gold_power_output")

minetest.register_abm({
  nodenames = {"tech:gold_power_output"},
  interval = 1,
  chance = 1,
  action = function(pos)
    local pows = {}
