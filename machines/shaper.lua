...
minetest.register_node("tech:shaper", {
  description = "Shaper",
...
tech.register_consumer("tech:shaper")

minetest.register_abm({
  nodenames = {"tech:shaper"},
  interval = 1,
  chance = 1,
  action = on_timer,
})
