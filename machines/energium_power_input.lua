minetest.register_node("tech:energium_power_input", {
  description = "Energium Power Input",
  tiles = {"tech_energium_power_input.png",},
...
tech.register_consumer("tech:energium_power_input")

minetest.register_abm({
  nodenames = {"tech:energium_power_input"},
  interval = 1,
  chance = 1,
  action = function(pos)
    local pows = {}
...
minetest.register_craft({
 type = "shapeless",
 output = "tech:energium_power_input",
 recipe = {"tech:energium_wire",
  "tech:gold_power_input",},
})
