...
tech.register_batbox("tech:batbox")

minetest.register_node("tech:batbox", {
  description = "Batbox",
  tiles = {"tech_batbox_side.png",
    "tech_batbox_side.png",
    "tech_batbox_side.png",
    "tech_batbox_side.png",
    "tech_batbox_side.png",
    "tech_batbox_side.png"},
...
minetest.register_craft({
  output = 'tech:batbox 1', 
  recipe = {
  {'', 'tech:wire', ''},
  {'tech:battery', 'tech:machine_casing', 'tech:battery'},
  {'', 'tech:battery', ''},
  }
})
