...
local function on_timer(pos)
  ...
  if inv then
    ...
    local res = tech.get_craft({type = "freeze", recipe = item:get_name()})
...
minetest.register_node("tech:freezer", {
 description = "Freezer",
...
tech.register_consumer("tech:freezer")

minetest.register_abm({
 nodenames = {"tech:freezer"},
 interval = 1,
 chance = 1,
 action = on_timer,
})
